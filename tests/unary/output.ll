...
entry:
  ...
  %SItoFPcast = sitofp i32 %n3 to float
  %addtmp = fadd float %SItoFPcast, %m4
  ...
  %SItoFPcast11 = sitofp i32 %n9 to float
  %addtmp12 = fadd float %SItoFPcast11, %negtmp
  ...
  %SItoFPcast22 = sitofp i32 %n18 to float
  %addtmp23 = fadd float %SItoFPcast22, %negtmp21
  ...
  %SItoFPcast33 = sitofp i32 %negtmp30 to float
  %addtmp34 = fadd float %SItoFPcast33, %negtmp32
